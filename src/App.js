...
function App() {
    ...
    const submitAddContent = async (e) => {
        ...
        try {
            await contract.methods.addContent(...params)
                ...
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse" id="navbarNav">
                        <ul className="navbar-nav">
                            ...
                            <li className="nav-item">
                                <button className="btn btn-light" onClick={() => setShowRegisterModal(!showRegisterModal)} >Register</button>
                            </li>
                            <li className="nav-item">
                            ...
                            <div className='d-flex flex-wrap justify-content-around mt-5'>
                                {userContent.length === 0 ? (
                                    <div className='alert alert-success' role='alert'>
                                        ...
                                        <b>You need to register first to use contract functions</b>
                                        <h5>OR</h5>
